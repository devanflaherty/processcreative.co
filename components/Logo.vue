  ...
  <router-link to="/" class="logo-link" :class="{'ready': ready}, status">
    <g class="symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g class="logo" transform="translate(0.000000, -1.000000)">
            <g class="logo-fill" ref="logoFill" :class="{'is-mobile': mobileNav}">
                <polygon class="slash" ref="slash" :style="`fill: ${primaryColor}`" points="97.2207 97.5187 -0.0003 338.8097 97.2577 338.8097 194.4727 97.5187"></polygon>
